    ...
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      <ScrollView contentContainerStyle={[styles.content, { paddingTop: insets.top + 18, paddingBottom: 110 }]} showsVerticalScrollIndicator={false}>
        ...
        <Text style={[styles.sectionTitle, { color: colors.foreground }]}>{t('about')}</Text>
         <Card style={styles.about}><View><Text style={[styles.aboutTitle, { color: colors.foreground }]}>{t('appName')}</Text><Text style={[styles.aboutDetail, { color: colors.mutedForeground }]}>{t('appVersion')}</Text></View><Feather name="info" size={18} color={colors.mutedForeground} /></Card>
